...
function getTotalReviewCount(book) {
  ...
  const librarything = book.reviews?.librarything?.reviewsCount ?? 0; // if undefined then 0
...
const pagesAllBooks = books.reduce((prev, book) => prev + book.pages, 0);
pagesAllBooks;
